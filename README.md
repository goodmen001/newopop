<div align="center">
<img width="768" src="https://cdn.jsdelivr.net/gh/goodmen001/newopop/images/openwrt.png"/>
...
- 固件默认管理地址：`XXXX` 默认用户：`XXXXX` 默认密码：`XXXXX`
- 提供适配于X86 平台设备的 OpenWrt 固件，并提供 Docker 镜像固件[➦使用方法](https://hub.docker.com/r/summary/openwrt-aarch64)
- 固件集成的所有 ipk 插件全部打包在 Packages 文件中，可以在 [Releases](https://github.com/goodmen001/newopop/releases) 内进行下载
...
点击下表中 [![](https://img.shields.io/badge/下载-链接-blueviolet.svg?style=flat&logo=hack-the-box)](https://github.com/goodmen001/newopop/releases) 即可跳转到该设备固件下载页面
| 平台+设备名称 | 固件编译状态 | 配置文件 | 固件下载 |
| :-------------: | :-------------: | :-------------: | :-------------: |
| [![](https://img.shields.io/badge/OpenWrt-X86_64位-32C955.svg?logo=openwrt)](https://github.com/goodmen001/newopop/blob/main/.github/workflows/X86_64-OpenWrt.yml) | [![](https://github.com/goodmen001/newopop/actions/workflows/X86_64-OpenWrt.yml/badge.svg)](https://github.com/goodmen001/newopop/actions/workflows/X86_64-OpenWrt.yml) | [![](https://img.shields.io/badge/编译-配置-orange.svg?logo=apache-spark)](https://goodmen001/newopop/blob/main/configs/x86_64.config) | [![](https://img.shields.io/badge/下载-链接-blueviolet.svg?logo=hack-the-box)](https://github.com/goodmen001/newopop/OpenWrt/releases/tag/X86_64) |
